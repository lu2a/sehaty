  ...
  useEffect(() => {
    async function checkMedicalFile() {
      ...
      if (error || !files) {
        ...
        // الحل هنا: تحويل المتغير لقراءة الاسم بدون أخطاء
  ...
  return (
    <div className="p-8 dir-rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* أزرار الوصول السريع */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 col-span-full lg:col-span-2">
