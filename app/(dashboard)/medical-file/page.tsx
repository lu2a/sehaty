...
export default function PregnancyPage() {
  ...
  return (
    <div className="p-4 min-h-screen dir-rtl font-cairo max-w-lg mx-auto bg-pink-50/30">
      <h1 className="text-xl font-bold mb-6 text-center text-pink-700">متابعة الحمل</h1>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-100 text-center mb-6">
        ...
        {record ? (
          <div>
            ...
            <p className="text-gray-500 text-sm">أنتِ الآن في الثلث {calculateWeek(lastPeriod) < 13 ? 'الأول' : calculateWeek(lastPeriod) < 27 ? 'الثاني' : 'الثالث'}</p>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        />
        <button onClick={handleSave} className="w-full bg-pink-600 text-white py-3 rounded-xl font-bold hover:bg-pink-700 transition flex items-center justify-center gap-2">
